...
echo "
	<div id='page-content-wrapper'>
		...
		<h3>Histórico de Devoluções dos Serviços Gerais</h3>
	</div>
	...
	<div id='page-content' style='margin-top:-18px;'>";
	 	if(isset($_GET['Id']))
        {
	        ...
	        if ($acao == 'ver') {	
				...
				$con=connection();
				$query="SELECT * FROM tbl_devolucao_servicos_gerais";
	            $result=mysqli_query($con,$query);
	            $row=mysqli_fetch_row($result);

	            echo "
	            	<div id='regbox'>
			<a href='h_devolucao_servicos_servicoes_gerais.php' style='padding-right: 10px; float:center; font-size:20px; background-color: #149900; color: #fff;' class='btn small'>
...
<table class='table' id='example1'>
	...
	echo "<tr>
			...
			<td>
	            <form method='get' action='h_devolucao_servicos_gerais.php'>
...
<a style='background-color: #149900; color: #fff;font-size:15px; padding:6px;' title='Imprimir' target='_blank' href='imprimir/imprimir_relatorio_d_s_gerais.php' class='print small btn primary-bg'>
