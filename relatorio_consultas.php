...
Morris.Bar({
    ...
    Morris.Donut({
        ...
        'use strict';
        for(var a=[],b=0;360>=b;b+=10)
            a.push({x:b,y:1.5+1.5*Math.sin(Math.PI*b/180).toFixed(4)});
    ...
    Morris.Area({
        ...
        data:[{x:'2013-03-30 22:00:00',y:3,z:3},{x:'2013-03-31 00:00:00',y:2,z:0},{x:'2013-03-31 02:00:00',y:0,z:2},{x:'2013-03-31 04:00:00',y:4,z:4}],
        xkey:'x',
        ykeys:['y','z'],
        labels:['Y','Z']
    }
...
Morris.Bar({
    ...
    $sql = "SELECT * FROM tbl_facturacao WHERE status='1'";
    $con = connection(); 
            ...
            window.m=Morris.Line(
                {
                    ...
                    labels:['sin(x)'],
                    parseTime:!1,
                    hoverCallback:function(a,b,c){var d=b.data[a];return c.replace('sin(x)','1.5 + 1.5 sin('+d.x+')')},
                    xLabelMargin:10,
                    integerYLabels:!0
                }
            )
