...
/*	Ajax para fazer a devolução dos serviços consultas */
$server='localhost';
$user='root';
	...
	$motivo = $_GET['motivo'];
				...
				if (strlen($motivo) < 5) {
					echo "0";
						...
						$queryInsert = "INSERT INTO tbl_devolucao_servicos_consultas VALUES ('', '$n_fatura', '$paciente', '$servico', '$total', '$motivo', '$data_devolucao')";
