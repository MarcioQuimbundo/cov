...
$lang = array_merge($lang,array(
	"ACCOUNT_SPECIFY_USERNAME" 		=> "Por favor entre com o nome de utilizador",
	"ACCOUNT_SPECIFY_PASSWORD" 		=> "Por favor entre com a palavra chave",
	"ACCOUNT_SPECIFY_EMAIL"			=> "Por favor entre com o teu endereço de email",
	"ACCOUNT_INVALID_EMAIL"			=> "Invalid email address",
	"ACCOUNT_USER_OR_EMAIL_INVALID"		=> "Nome utilizador inválido",
	"ACCOUNT_USER_OR_PASS_INVALID"		=> "Credenciais inválidos, tente novamente",
	"ACCOUNT_ALREADY_ACTIVE"		=> "A tua conta já foi activada",
