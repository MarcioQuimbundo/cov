...
echo "
	...
	<div id='page-content' style='margin-top:-18px;'>"; 
		...
		if (isset($_POST['finalizar_consulta'])){
			...
			$query="INSERT INTO tbl_atendimento_medico VALUES (Null, '$id_paciente','$id_medico','$data','consulta')";
			...
			if($a){
				mysqli_query($con,"UPDATE tbl_paciente SET atendido_medico=1 WHERE Id = '$id_paciente'");
			   	echo "<script>alert('Atendimento finalizado com sucesso');</script>";
				echo "<script>document.location.href = 'pacientes_consulta.php';</script>";        
			            die();
			}         
			else echo "
			            <div class='row'>
		...
		if (isset($_POST['editar_exame_clinico'])) {
			...
			$con = connection();					
				...
				$a=mysqli_query($con,$query) ? true : false ;
				if($a){
						echo "<script>alert('Exame Clinico actualizado com sucesso');</script>";
						echo "<script>document.location.href = 'pacientes_consulta.php?Id=$id_paciente&acao=consultar&menu=exame_clinico';</script>";        
				}
				else { echo "	
							<div class='row'>
								<div class='col-md-6'>
									<div class='infobox error-bg mrg0A'>
										<p>Ocorreu um erro, exame clínico não foi actualizado na base de dados.</p>
									</div>
								</div>
							</div>
						";
		...
		if (isset($_POST['add_exame_clinico'])) {
			...
			if($a){
			    ...
			    echo "<script>alert('Exames clínico adicionado com sucesso');</script>";
				echo "<script>document.location.href = 'pacientes_consulta.php?Id=$id_paciente&acao=consultar&menu=exame_clinico';</script>";
			}              
			else { echo "
			            <div class='row'>
			        ...
			        ";
			echo "<script>document.location.href = 'pacientes_consulta.php?Id=$Id&acao=consultar&menu=exame_clinico';</script>";
			}         
		...
		if (isset($_POST['add_atendimento'])) {
			...
			$a = mysqli_query($con,$query) ? true : false ;
			if($a){				
			    echo "<script>alert('Resumo do atendimento adicionado com sucesso');</script>";
			    echo "<script>document.location.href = 'pacientes_consulta.php?Id=$id_paciente&acao=consultar&menu=diario_clinico';</script>";       
		...
		if (isset($_POST['salvar_justificativo_medico'])) {
			...
			if($a){
			    ...
			    echo "<script>alert('Justificativo salvo com sucesso');</script>";
			    echo "<script>document.location.href = 'pacientes_consulta.php?Id=$id_paciente&acao=consultar&menu=transferencia_justificativo';</script>";		      
			        ...
			        ";
			echo "<script>document.location.href = 'pacientes_consulta.php?Id=$Id&acao=consultar&menu=transferencia_justificativo';</script>";					}         
			}
		...
		if (isset($_POST['salvar_antecedentes'])) {
			...
			if($a){
			    ...
			    echo "<script>alert('Antecedentes armazenadas com sucesso');</script>";
		    ...
		    if ($acao == 'consultar') {			    
				...
				if (isset($_POST['editar_transferencia_justificativo'])) {
					...
					$data 			= 	date('Y-m-d');
						...
						$a=mysqli_query($con,$query) ? true : false ;
						if($a){
								echo "<script>alert('Justificativo médico atualizado com sucesso');</script>";
						}
						else echo "	
									<div class='row'>
										<div class='col-md-6'>
											<div class='infobox error-bg mrg0A'>
												<p>Ocorreu um erro, o Justificativo médico não foi actualizado na base de dados.</p>
											</div>
										</div>
									</div>
								";
				...
				if (isset($_POST['editar_antecedentes'])) {
						...
						$a=mysqli_query($con,$query) ? true : false ;
						if($a){
								echo "<script>alert('Antecedentes actualizados com sucesso');</script>";
						}
						else echo "	
									<div class='row'>
										<div class='col-md-6'>
											<div class='infobox error-bg mrg0A'>
												<p>Ocorreu um erro, antecedentes não foi actualizado na base de dados.</p>
											</div>
										</div>
									</div>
								";
			...
			<br>
		    		...
		    		echo"
									...
									<table class='table' id='example1'>
										...
										$query = "	SELECT 
													...
													inner join tbl_medico 
													on(tbl_exame_clinico_consultado.id_medico=tbl_medico.id_medico) WHERE tbl_exame_clinico_consultado.id_paciente = $Id";
										...
										echo "<tr>
												<td>
													<a href='pacientes_consulta.php?Id=".$row['id_paciente']."&acao=consultar&ver_ex=1&exame_clinico_id=".$row['exame_clinico_id']."' class='tooltip-button' data-placement='top' title='Ver'>".$row['nome_paciente']."</a></td>
												<td>
													<a href='pacientes_consulta.php?Id=".$row['id_paciente']."&acao=consultar&ver_ex=1&exame_clinico_id=".$row['exame_clinico_id']."' class='tooltip-button' data-placement='top' title='Ver'>".$row['nome_medico']."</a></td>
												<td>
												...
												";
													echo "
													<a href='imprimir/imprimir_exame_clinico.php?id=".$Id."' target='_blank' class='btn small bg-blue-alt tooltip-button' data-placement='top' title='Imprimir'>
				...
				if(isset($_GET['ver_diario'])) {
		    		...
		    		echo"		<br><br><br>
								<input type='hidden' value='$rowP[0]' name = 'id_paciente'>
									<div class='col-md-9' style='margin-left:10px; margin-top:-40px;'>
										<h2 class='text-center'>Histórico</h2><br>
					<a href='pacientes_historico.php' style='padding-right: 10px; float:center; font-size:20px; background-color: #149900; color: #fff;' class='btn small'>
					...
					<hr><br>										
						...
						$query = "	SELECT 
									...
									inner join tbl_medico 
									on(tbl_diario_clinico.medico=tbl_medico.id_medico) WHERE tbl_diario_clinico.id_paciente = $Id AND tbl_diario_clinico.id_atendimento = $id_diario";			
						//var_dump($query);													
						$resultP=mysqli_query($con,$query);
						$rowP=mysqli_fetch_row($resultP);
						echo"
				...
				if(isset($_GET['ver_justificativo'])) {
		    		...
		    		echo"
						...
						$query = "SELECT 
									...
									inner join tbl_medico 
									on(tbl_justificativo_medico.id_medico=tbl_medico.id_medico) WHERE tbl_justificativo_medico.id_paciente = $Id AND tbl_justificativo_medico.id_justificativo_medico = $id_justificativo";			
						//var_dump($query);													
						$resultP=mysqli_query($con,$query);
						$rowP=mysqli_fetch_row($resultP);
						echo"
				...
				if(isset($_GET['ver_receita'])) {
		    		...
		    		echo"
						...
						$query = "	SELECT 
									...
									inner join tbl_medico 
									on(tbl_receitas.medico=tbl_medico.id_medico) WHERE tbl_receitas.id_paciente = $Id AND tbl_receitas.id_receita = $id_receita";			
						//var_dump($query);													
						$resultP=mysqli_query($con,$query);
						$rowP=mysqli_fetch_row($resultP);
						echo"
		    	...
		    	if(isset($_GET['menu']) AND $_GET['menu'] == 'diario_clinico') {
		    		...
		    		echo 	"
									...
									<table class='table' id='example1'>
										...
										$data = date("m.d.Y");
										$query = "	SELECT 
													tbl_diario_clinico.id_atendimento as id_atendimento,
													tbl_paciente.Id as id_paciente, 
													tbl_paciente.nome as nome_paciente,
													tbl_medico.nome as nome_medico,
													tbl_diario_clinico.data as data,
													tbl_diario_clinico.servico as servicos,
													tbl_diario_clinico.resumo_atendimento as resumo_atendimento
													FROM `tbl_diario_clinico` 
													inner join tbl_paciente 
													on(tbl_paciente.Id=tbl_diario_clinico.id_paciente) 
													inner join tbl_medico 
													on(tbl_diario_clinico.medico=tbl_medico.id_medico)
													WHERE tbl_diario_clinico.id_paciente = $Id 
													ORDER BY tbl_diario_clinico.data ASC";
										$result=mysqli_query($con,$query);
										while($row=mysqli_fetch_array($result)) 
										{
										echo "<tr>
						...
						echo "	<input type='hidden' value='$rowP[0]' name = 'id_paciente'>
									<div class='col-md-9' style='margin-left:10px; margin-top:-40px;'>
										<h2 class='text-center'>Resumo do atendimento</h2><br><hr>		
											            ...
											            <div class='row'>
												            <div class='form-input col-md-7' style='margin-left: 20%' >
											                	<textarea placeholder='Escreva o resumo do Atendimento...' name='resumo_atendimento' class='form-control' rows='33'></textarea>
											                </div>
										                </div>
										                <div class='row text-center'>
				...
				if(isset($_POST['tratamentos_e_recomendacoes'])) {
		    		$query="SELECT DISTINCT * FROM tbl_triagem WHERE id_paciente = '$Id'";
		    		$queryP="SELECT DISTINCT * FROM tbl_paciente WHERE Id = '$Id'";
				...
				if (isset($_POST['add_receita'])) {
					...
					$a = mysqli_query($con,$query) ? true : false ;
					if($a){
						echo "<script>alert('Receita gerada com sucesso');</script>";
		    		...
		    		echo"
									...
									<table class='table' id='example1'>
										...
										$query = "	SELECT 
													...
													on(tbl_paciente.Id=tbl_receitas.id_paciente) 
													inner join tbl_medico 
													on(tbl_receitas.medico=tbl_medico.id_medico) WHERE tbl_receitas.id_paciente = '$Id'";
										...
										echo "<tr>
												<td>
													<a href='pacientes_consulta.php?Id=".$row['id_paciente']."&acao=consultar&ver_receita=1&id_receita=".$row['id_receita']."' class='tooltip-button' data-placement='top' title='Ver'>".$row['nome_paciente']."</a></td>
												<td>
													<a href='pacientes_consulta.php?Id=".$row['id_paciente']."&acao=consultar&ver_receita=1&id_receita=".$row['id_receita']."' class='tooltip-button' data-placement='top' title='Ver'>".$row['nome_medico']."</a></td>
												<td>
												...
												<td>
													...
													";
													echo "
														<a target='_blank' href='imprimir/imprimir_receita.php?id=".$row['id_paciente']."' class='btn small bg-blue-alt tooltip-button' data-placement='top' title='Imprimir'>
															<i class='glyph-icon icon-print'></i>
														</a>
						...
						if($a){
								...
								echo "<script>document.location.href = 'pacientes_consulta.php?Id=$Id&acao=consultar&menu=receituario';</script>";	     
									...
									<div class='row'>
										<div class='col-md-6'>
											<div class='infobox error-bg mrg0A'>
												<p>Ocorreu um erro, Receita não foi atualizada na base de dados.</p>
											</div>
										</div>
									</div>
								";
		    		...
		    		echo"
									...
									<table class='table' id='example1'>
										...
										$query = "	SELECT 
													...
													on(tbl_paciente.Id=tbl_justificativo_medico.id_paciente) 
													inner join tbl_medico 
													on(tbl_justificativo_medico.id_medico=tbl_medico.id_medico) WHERE tbl_justificativo_medico.id_paciente = $Id";
										...
										echo "<tr>
												<td>
													<a href='pacientes_consulta.php?Id=".$row['id_paciente']."&acao=consultar&ver_justificativo=1&id_justificativo=".$row['id_justificativo']."' class='tooltip-button' data-placement='top' title='Ver'>".$row['nome_paciente']."</a></td>
												<td>
													<a href='pacientes_consulta.php?Id=".$row['id_paciente']."&acao=consultar&ver_justificativo=1&id_justificativo=".$row['id_justificativo']."' class='tooltip-button' data-placement='top' title='Ver'>".$row['nome_medico']."</a></td>
												<td>
												<a href='pacientes_consulta.php?Id=".$row['id_paciente']."&acao=consultar&ver_justificativo=1&id_justificativo=".$row['id_justificativo']."' class='tooltip-button' data-placement='top' title='Ver'>".$row['data']."</a></td>
												<td>
												<form method='get' action='pacientes_consulta.php'>
												";
													echo "
													<a href='imprimir/imprimir_justificativo_medico.php?id=".$Id."' target='_blank' class='btn small bg-blue-alt tooltip-button' data-placement='top' title='Imprimir'>
												        <i class='glyph-icon icon-print'></i>
													</a>	
													<a href='pacientes_consulta.php?Id=".$row['id_paciente']."&acao=consultar&ver_justificativo=1&id_justificativo=".$row['id_justificativo']."' class='btn small bg-blue-alt tooltip-button' data-placement='top' title='Ver'>
														<i class='glyph-icon icon-eye'></i>
													</a>										
												</form>
												</td>
				...
				echo "
									<table class='table' id='example1'>
										...
										{
										echo "<tr>
												<td><a href='pacientes_historico.php?Id=".$row['id_paciente']."&acao=consultar&ver_diario=1&id_diario=".$row['id_atendimento']."'>".$row['data']."</a></td>
												<td><a href='pacientes_historico.php?Id=".$row['id_paciente']."&acao=consultar&ver_diario=1&id_diario=".$row['id_atendimento']."'>".$row['servicos']."</a></td>
												<td><a href='pacientes_historico.php?Id=".$row['id_paciente']."&acao=consultar&ver_diario=1&id_diario=".$row['id_atendimento']."'>".$row['nome_medico']."</a></td>
												<td><a href='pacientes_historico.php?Id=".$row['id_paciente']."&acao=consultar&ver_diario=1&id_diario=".$row['id_atendimento']."'>".$row['nome_paciente']."</a></td>
												<td>
													<a target='_blank' href='imprimir/imprimir_diario_clinico.php?id=".$row['id_atendimento']."' class='btn small bg-blue-alt tooltip-button' data-placement='top' title='Imprimir'>
														<i class='glyph-icon icon-print'></i>
													</a>
													<a href='pacientes_historico.php?Id=".$row['id_paciente']."&acao=consultar&ver_diario=1&id_diario=".$row['id_atendimento']."' class='btn small bg-blue-alt tooltip-button' data-placement='top' title='Ver'>
														<i class='glyph-icon icon-eye'></i>
													</a>
												</td>
											</tr>";
