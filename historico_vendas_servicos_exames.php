...
echo "
	<div id='page-content-wrapper'>
		...
		<h3>Histórico de Vendas dos Exames</h3>
	</div>
 	...
 	if(isset($_GET['Id']))
        {
            ...
            echo "
            <div id='regbox'>
			<a href='historico_vendas_servicos_exames.php' style='padding-right: 10px; float:center; font-size:20px; background-color: #149900; color: #fff;' class='btn small'>
...
<table class='table' id='example1'>
	...
	$query="SELECT * FROM tbl_facturacao INNER JOIN tbl_users ON(tbl_facturacao.funcionario = tbl_users.id) WHERE FIND_IN_SET('$nomeConsulta',servico)";
	$result=mysqli_query($con,$query);
	...
	echo "<tr>
			...
			<td>".$row['data']."</td>
			<td>
	            <form method='get' action='historico_vendas_servicos_exames.php'>
	                <a href='historico_vendas_servicos_exames.php?Id=".$row['facturacao_id']."&acao=ver&facturaId=".$row['facturacao_id']."' class='btn small bg-blue-alt tooltip-button' data-placement='top' title='Ver'>
...
<a style='background-color: #149900; color: #fff;font-size:15px; padding:6px;' title='Imprimir' target='_blank' href='imprimir/imprimir_relatorio_v_s_exames.php' class='print small btn primary-bg'>
